    ...
    <script>
        $(document).ready(function() {
            $('#sample_form').on('submit', function(event) {
                ...
                $.ajax({
                    url: "https://rafikaaprida8.amisbudi.cloud/portofolio-rafika/si-admin/api/auth/login.php",
                    method: "POST",
                    data: JSON.stringify(formData),
                    success: function(data) {
                        $('#action_button').attr('disabled', false);
                        window.location.href = 'https://rafikaaprida8.amisbudi.cloud/portofolio-rafika/';
                    },
                    error: function(err) {
                        console.log(err);
